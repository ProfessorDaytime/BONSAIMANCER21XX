...
public class TreeNode
{
    ...
    /// <summary>True for a pot-bound root that has grown out through a drainage hole in the pot's
    /// floor (instead of being clamped at the bottom face). A visible "needs repotting" tell.</summary>
    public bool escapedRoot;
