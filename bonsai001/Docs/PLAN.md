...
| # | Item | Status / notes |
|---|------|----------------|
| 1 | **H — Item Selection Menus** | ✅ done (pots / rocks / tables). GroundCover (moss & grass) folds into Decoration (#4). See Completed This Phase. |
| 2 | **20 — Multi-Tree / Quick-Start** | ✅ done — Quick-Start generator + tree shelf with save-before-switch. See Completed This Phase. |
| — | **Flower / Blossom & Fruit System** | ✅ core built 2026-06-14 — `FlowerManager` (flowers + fruit lifecycle), 14/17 species configured (all conifers cone). Follow-ups: showier blossom geometry, Azalea/Magnolia species, birch/willow catkins. See Completed This Phase. |
...
| 3 | **19 — Gamification & Tutorial Progression** | ✅ core complete 2026-06-14 (`Docs/PROGRESSION_DESIGN.md`) — all 4 slices built: economy + zen core, cosmetic shop, Career/Sandbox gating + mode toggle, and the Journal/Encyclopedia (Achievements + Techniques/Phenomena/Species) with real milestone hooks (trim/wire/repot/bloom/fruit/survival). Remaining = ongoing balance tuning + optional richer tutorials. |
| 4 | **21 — Decoration & Cosmetic Unlockables** | 🔨 expanded scope: Decoration + **Background / Music / UI Theme** unlockables, all via the AP shop. **Backgrounds + scaffolding ✅, UI Themes ✅, Music ✅ built 2026-06-15** (`CustomizeManager`, `BackgroundManager`, `UiTheme` palette + 5 themes + full game-UI theming, `MusicManager`, equipped-state persistence, ⚙ Customize menu). Next: **Decoration placeables** (the original #21). See `Docs/PROGRESSION_DESIGN.md` §7. |
